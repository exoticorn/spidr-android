...
class Native
{
	...
	static native void handleGamepadStickEvent(long gameFramework, float x, float y);
	static native void handleGamepadButtonEvent(long gameFramework, int button, boolean down);
